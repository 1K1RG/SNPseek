...
legendpath="/usr/local/tomcat/webapps/v3/haplo/legend.png"
...
#            } else if(annot=='G') {
            } else if(grepl('gene_variant',annot)) {
              snplinecolor[iposcnt]='darkgray'
#            } else if(annot=='E') {
            } else if(grepl('exon_variant',annot)) {
              snplinecolor[iposcnt]='brown'
#            } else if(annot=='N') {
            } else if(grepl('nonsynonymous_variant',annot)) {
              snplinecolor[iposcnt]='red'
              positions_y[iposcnt]=0
#            } else if(annot=='S') {
            } else if(grepl('synonymous_variant',annot)) {
              snplinecolor[iposcnt]='orange'
              positions_y[iposcnt]=0
#            } else if(annot=='3') {
            } else if(grepl('3_prime_UTR',annot)) {
              snplinecolor[iposcnt]='darkgreen'
#            } else if(annot=='5') {
            } else if(grepl('5_prime_UTR',annot)) {
              snplinecolor[iposcnt]='darkblue'
#            } else if(annot=='D') {
            } else if(grepl('splice_donor_variant',annot)) {
              snplinecolor[iposcnt]='cyan'
#            } else if(annot=='A') {
            } else if(grepl('splice_acceptor_variant',annot)) {
              snplinecolor[iposcnt]='lightgreen'
#            } else if(annot=='P') {
            } else if(grepl('promoter_variant',annot)) {
