      ...
      function (t, e) {
        ...
        e.exports = {
          enable: function (t) {
            ...
            e ||
              ((e = document.createElementNS(o.svgNS, "defs")),
              t.svg.appendChild(e));
      ...
      function (t, e) {
        ...
        (i.prototype.init = function (t, e) {
          (this.viewport = t),
            ...
            (this.updateCTMCached = n.proxy(this.updateCTM, this)),
            (this.requestAnimationFrame = n.createRequestAnimationFrame(
          ...
          (i.prototype.cacheViewBox = function () {
            ...
            if (t) {
              ...
              (this.viewBox.x = n.x),
                (this.viewBox.y = n.y),
                (this.viewBox.width = n.width),
                (this.viewBox.height = n.height);
            }
          }),
                ...
                i === !1
                  ...
                  : n.isObject(i) &&
                    (i.x === !1
                      ...
                      : n.isNumber(i.x) && (t.e = i.x),
                    i.y === !1
                      ? ((t.f = this.getPan().y), (r = !0))
                      : n.isNumber(i.y) && (t.f = i.y)),
                  s && r && (o = !1);
              }
              (e || o) &&
                (this.updateCache(t),
          ...
          (i.prototype.pendingUpdate = !1),
          (i.prototype.updateCTMOnNextFrame = function () {
            this.pendingUpdate ||
              ((this.pendingUpdate = !0),
              this.requestAnimationFrame.call(window, this.updateCTMCached));
          }),
          (i.prototype.updateCTM = function () {
            o.setCTM(this.viewport, this.getCTM(), this.defs),
      ...
      function (t, e) {
        ...
        (a.prototype.init = function (t, e) {
          ...
          (this.svg = t),
            ...
            s.setupSvgAttributes(this.svg),
            (this.options = i.extend(i.extend({}, l), e)),
            (this.state = "none");
            ...
            (this.viewport = r(
              s.getOrCreateViewport(this.svg, this.options.viewportSelector),
              {
                ...
                beforeZoom: function (t, e) {
                  return o.viewport && o.options.beforeZoom
                    ? o.options.beforeZoom(t, e)
                    : void 0;
                },
                onZoom: function (t) {
                  return o.viewport && o.options.onZoom
                    ? o.options.onZoom(t)
                    : void 0;
                },
                beforePan: function (t, e) {
                  return o.viewport && o.options.beforePan
                    ? o.options.beforePan(t, e)
                    : void 0;
                },
                onPan: function (t) {
                  return o.viewport && o.options.onPan
                    ? o.options.onPan(t)
                    : void 0;
                },
              },
          ...
          u.setBeforeZoom(this.options.beforeZoom),
            u.setOnZoom(this.options.onZoom),
            u.setBeforePan(this.options.beforePan),
            u.setOnPan(this.options.onPan),
            this.options.controlIconsEnabled && n.enable(this),
          ...
          (a.prototype.publicZoomAtPoint = function (t, e, o) {
            if (
              ...
              !("SVGPoint" !== i.getType(e) && "x" in e && "y" in e))
            )
              throw new Error("Given point is invalid");
            (e = s.createSVGPoint(this.svg, e.x, e.y)),
          ...
          (a.prototype.handleMouseDown = function (t, e) {
            this.options.preventMouseEventsDefault &&
              (t.preventDefault ? t.preventDefault() : (t.returnValue = !1)),
              i.mouseAndTouchNormalize(t, this.svg),
              this.options.dblClickZoomEnabled && i.isDblClick(t, e)
                ...
                (this.publicInstance = this.pi =
                  {
                    ...
                    enableControlIcons: function () {
                      return (
                        t.options.controlIconsEnabled ||
                          ((t.options.controlIconsEnabled = !0), n.enable(t)),
                        t.pi
                      );
                    },
                    disableControlIcons: function () {
                      return (
                        t.options.controlIconsEnabled &&
                          ((t.options.controlIconsEnabled = !1), n.disable(t)),
                        t.pi
                      );
                    },
        ...
        var u = [],
          h = function (t, e) {
            ...
            return (
              u.push({ svg: o, instance: new a(o, e) }),
                ...
                if (r && r.length > 0)
                  for (var a = r.length; a > 0; a--)
                    "defs" !== r[r.length - a].nodeName &&
                      n.appendChild(r[r.length - a]);
                t.appendChild(n);
              }
              var l = [];
              return (
                n.getAttribute("class") &&
                  (l = n.getAttribute("class").split(" ")),
                ~l.indexOf("svg-pan-zoom_viewport") ||
                  (l.push("svg-pan-zoom_viewport"),
                  n.setAttribute("class", l.join(" "))),
                n
              );
            },
        ...
        e.exports = (function () {
          function t(t, e, o) {
            var n = function (t) {
              ...
              return (
                "mousewheel" == u
                  ? ((o.deltaY = (-1 / 40) * t.wheelDelta),
                    t.wheelDeltaX && (o.deltaX = (-1 / 40) * t.wheelDeltaX))
                  : (o.deltaY = t.detail),
                e(o)
              );
            };
      ...
      function (t, e) {
        ...
        e.exports = {
          extend: function (t, e) {
            t = t || {};
            for (var o in e)
              t[o] = this.isObject(e[o]) ? this.extend(t[o], e[o]) : e[o];
            return t;
          },
          ...
          createRequestAnimationFrame: function (t) {
            var e = null;
            return (
              "auto" !== t && 60 > t && t > 1 && (e = Math.floor(1e3 / t)),
              null === e ? window.requestAnimationFrame || o(33) : o(e)
            );
          },
        };
      },
