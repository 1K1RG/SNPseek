...
public class OAuthUtils {
  ...
  public static GoogleAuthorizationCodeFlow newFlow() throws IOException {
    ...
    final String oauthClientId = System.getenv(SNPseekEnv.GOOGLE_OAUTH_CLIENT_ID);
    final String oauthClientSecret = System.getenv(SNPseekEnv.GOOGLE_OAUTH_CLIENT_SECRET);
