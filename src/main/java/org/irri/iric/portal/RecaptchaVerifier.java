...
public class RecaptchaVerifier {
	...
	/**
	 * Refer to https://developers.google.com/recaptcha/docs/verify You can simplify
	 * this method with Apache HttpClient library.
	 * 
	 * @param captchaResponse
	 * @return a JSON object { "success": true|false, "challenge_ts": timestamp, //
	 *         timestamp of the challenge load (ISO format yyyy-MM-dd'T'HH:mm:ssZZ)
	 *         "hostname": string, // the hostname of the site where the reCAPTCHA
	 *         was solved "error-codes": [...] // optional }
	 * @throws Exception
	 */
