...
--
-- Name: iric1; Type: DATABASE; Schema: -; Owner: -
--

CREATE DATABASE iric1 WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'C';
...
--
-- Name: snpseekv2; Type: SCHEMA; Schema: -; Owner: -
--

CREATE SCHEMA snpseekv2;


--
-- Name: SCHEMA snpseekv2; Type: COMMENT; Schema: -; Owner: -
--

COMMENT ON SCHEMA snpseekv2 IS 'standard public schema';
...
CREATE TABLE public."user" (
    ...
    emailadd character varying(250),
    roleid integer,
...
CREATE VIEW public.v_organism AS
 SELECT organism.organism_id,
  ...
  WHERE ((organism.common_name)::text = ANY (ARRAY[('Japonica nipponbare'::character varying)::text, ('IR64-21'::character varying)::text, ('93-11'::character varying)::text, ('DJ123'::character varying)::text, ('Kasalath'::character varying)::text]))
...
--
-- Name: SCHEMA snpseekv2; Type: ACL; Schema: -; Owner: -
--

GRANT ALL ON SCHEMA snpseekv2 TO PUBLIC;
